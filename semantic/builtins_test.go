...
func TestSemantics_builtins(t *testing.T) {
	...
	t.Run("string", func(t *testing.T) {
		tests := []struct {
			...
			{tp: &HashMapType{Key: TInt, Value: TString}, expected: "hashmap[int]string"},
			{tp: &MapType{Key: TInt, Value: TString}, expected: "map[int]string"},
